...
assert_jq     "bad-app[0]: hasLiveness=false"          pods.json  pod-review.jq  '.pods[0].containers[0].hasLiveness == false'
assert_jq     "bad-app[0]: pullPolicy=Always"          pods.json  pod-review.jq  '.pods[0].containers[0].pullPolicy == "Always"'
assert_jq     "bad-app[0]: allowPrivEsc=true (no ctx)" pods.json  pod-review.jq  '.pods[0].containers[0].allowPrivEsc == true'
assert_jq     "bad-app[0]: runAsNonRoot=false (no ctx)" pods.json pod-review.jq  '.pods[0].containers[0].runAsNonRoot == false'
assert_jq     "good-app[2]: hasLiveness=true"          pods.json  pod-review.jq  '.pods[2].containers[0].hasLiveness == true'
assert_jq     "good-app[2]: hasRequests=true"          pods.json  pod-review.jq  '.pods[2].containers[0].hasRequests == true'
